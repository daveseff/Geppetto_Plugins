...
Adds a `letsencrypt_cert` operation that issues or renews certificates with certbot using the webroot HTTP-01 challenge.
...
- `webroot` (string, required): Path served over HTTP for the HTTP-01 challenge.
